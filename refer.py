...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        if dataset in ['refcoco', 'refcoco+', 'refcocog']:
            ...
            # Updated path for RRSISD dataset images
            self.IMAGE_DIR = "/10T/students/doctor/2025/zum/PyCharm-Remote/FIANet/refer/data/images/rrsisd/JPEGImages/"
        else:
        ...
        # For RRSISD dataset, use the provided path for instances.json
        if dataset == 'rrsisd':
            instances_file = "/10T/students/doctor/2025/zum/PyCharm-Remote/FIANet/refer/data/rrsisd/instances.json"
        else:
...
if __name__ == '__main__':
    ...
    refer = REFER(data_root='data', dataset='rrsisd', splitBy='unc')
